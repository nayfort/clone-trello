	...
	<main class="mt-3">
		<form @submit.prevent="handleSubmit" class="mb-4 flex gap-2 items-center">
			<Input
				...
				class="border border-slate-300 p-2 rounded w-full dark:bg-slate-600 dark:text-white"
				required
			/>
			<button
				type="submit"
				class="bg-blue-500 hover:bg-blue-800 text-white font-bold py-2 px-4 rounded text-nowrap"
			>
				{{ $t('ADD_PROJECT') }}
			</button>
		</form>
